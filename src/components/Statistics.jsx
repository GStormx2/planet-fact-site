...
const Statistics = (props) => {
    ...
    return (
        <div className="px-7 xl:w-full xl:px-48 md:p-0 md:mt-10 md:mr-10 md:ml-7 lg:mt-16 mt-7 mb-10 flex flex-col md:flex-row md:justify-evenly xl:text-left xl:absolute xl:mb-0 xl:ml-0 xl:bottom-0">
