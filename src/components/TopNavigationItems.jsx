...
const TopNavigationItems = (props) => {
    return (
        <div className={`xl:mr-5 flex-1 flex flex-col justify-between items-center focus:outline-none hover:cursor-pointer}`} 
        onClick={()=> props.setSelectedPlanet(props.name)}>
            ...
            <p className={`flex-1 mb-5 xl:mt-5 xl:mb-5 xl:m-0 font-spartan font-bold text-tab-md text-cwhite uppercase tracking-widest ${props.selectedPlanet === props.name ? "opacity-100" : "opacity-75"}  hover:cursor-pointer`} >{props.name}</p>
