...
const MediumMenuItems = (props) => {
    ...
    return (
        <button className={`w-72 lg:w-96 mt-3 xl:mt-5 h-10 lg:h-14 text-left focus:outline-none ${props.name === props.selectedMenu ? colorPalletMenu[props.selectedPlanet.toLowerCase()] : "hover:bg-cgray hover:bg-opacity-25"} border border-cgray border-opacity-20`} onClick={() => props.setSelectedMenu(props.name)}>
